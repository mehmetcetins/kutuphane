...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 25 May 2017, 18:21:52
...
(18, '228', '2017-05-25', '2017-05-27', 9),
(19, '228', '2017-05-25', '2017-05-27', 5);
...
CREATE TABLE `ogrenci` (
  `id` int(11) NOT NULL,
  `ogrenci_no` varchar(5) COLLATE utf8_turkish_ci NOT NULL,
  `ad` varchar(30) COLLATE utf8_turkish_ci NOT NULL,
  `soyad` varchar(30) COLLATE utf8_turkish_ci NOT NULL,
  `sınıf` varchar(4) COLLATE utf8_turkish_ci NOT NULL,
  `alanı` varchar(20) COLLATE utf8_turkish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
INSERT INTO `ogrenci` (`id`, `ogrenci_no`, `ad`, `soyad`, `sınıf`, `alanı`) VALUES
(1, '228', 'Mehmet', 'ÇETİN', '12-E', 'Bilişim');
